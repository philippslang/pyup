...
\title[Flow-based Upscaling]{PyUp: Flow-based Permeability Upscaling in Python}% Force line breaks with \\
\thanks{https://github.com/plang85/PyUp}

\author{Philipp S. Lang}
 \email{p.lang13@imperial.ac.uk}
\affiliation{ 
Department of Earth Science and Engineering, Imperial College, London, UK%\\This line break forced with \textbackslash\textbackslash
}%
...
\keywords{upscaling, flow-based, permeability tensor}%Use showkeys class option if keyword
                              %display desired
\maketitle
